...
pub async fn get_presence(
...
) -> Result<Json<Vec<Presence>>, StatusCode> {
    ...
    let presence_list: Vec<Presence> = presence_map.values()
...
pub async fn update_presence(
    ...
    info!("PUT /chat/{}/presence - {} is {:?}", room_id, presence.user, presence.status);
    ...
    let update = crate::store::json_store::RoomUpdate {
        ...
        update_type: crate::store::json_store::UpdateType::Presence,
