use crate::vendor::rle::{AppendRle, HasLength, RleRun};
use crate::vendor::diamond_types::encoding::Merger;
use crate::vendor::diamond_types::list::encoding::leb::num_encode_zigzag_isize_old;
use crate::vendor::diamond_types::list::encoding::encode_tools::{push_leb_usize, write_leb_bit_run};
