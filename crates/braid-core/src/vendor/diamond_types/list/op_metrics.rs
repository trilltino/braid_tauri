...
use crate::vendor::rle::{HasLength, MergableSpan, SplitableSpan, SplitableSpanCtx};
...
use crate::vendor::diamond_types::list::switch;
use crate::vendor::diamond_types::dtrange::DTRange;
use crate::vendor::diamond_types::rev_range::RangeRev;
use crate::vendor::diamond_types::unicount::chars_to_bytes;
#[cfg(feature = "serde")]
...
#[cfg(test)]
mod test {
    use crate::vendor::rle::{SplitableSpanCtx, test_splitable_methods_valid_ctx};
