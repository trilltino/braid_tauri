...
use crate::vendor::rle::{HasLength, RleDRun, SplitableSpan};
...
use crate::vendor::diamond_types::listmerge::M2Tracker;
use crate::vendor::diamond_types::listmerge::markers::Marker;
use crate::vendor::diamond_types::listmerge::merge::notify_for;
use crate::vendor::diamond_types::LV;
use crate::vendor::diamond_types::ost::LeafIdx;
    ...
    pub(super) fn adv_retreat_range(&mut self, mut range: DTRange, incr: i32) {
        ...
        while !range.is_empty() {
            if let Some(mut cursor) = self.range_tree.try_find_item(range.start) {
                // crate::vendor::diamond_types::stats::marker_a();
                ...
                // crate::vendor::diamond_types::stats::marker_b();
