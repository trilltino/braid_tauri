...
use crate::vendor::rle::{AppendRle, HasLength, HasRleKey, MergableSpan};
use crate::vendor::diamond_types::{CausalGraph, DTRange, Frontier, LV};
...
pub(crate) struct M1EntryState {
    ...
    // DIRTY.
    pub concurrent_parents: SmallVec<[usize; 2]>,
...
mod test {
    ...
    use crate::vendor::diamond_types::causalgraph::graph::{Graph, GraphEntrySimple};
    use crate::vendor::diamond_types::causalgraph::graph::random_graphs::with_random_cgs;
    use crate::vendor::diamond_types::causalgraph::graph::tools::DiffFlag;
