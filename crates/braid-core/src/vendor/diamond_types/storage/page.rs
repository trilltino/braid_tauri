...
use crate::vendor::diamond_types::encoding::tools::{calc_checksum, ExtendFromSlice, TryExtendFromSlice};
use crate::vendor::diamond_types::encoding::varint::*;
use crate::vendor::diamond_types::storage::*;
...
#[inline]
pub(in crate::vendor::diamond_types::storage) fn page_checksum_offset(is_header: bool) -> usize {
    if is_header {
        MAGIC_BYTES.len()
    } else { 0 }
}
...
#[cfg(test)]
mod test {
    use crate::vendor::diamond_types::encoding::tools::{ExtendFromSlice, TryExtendFromSlice};
    use crate::vendor::diamond_types::storage::page::{BlitStatus, Page, DataPageImmutableFields, DataPage};
    use crate::vendor::diamond_types::storage::{DataPageType, PageType};
