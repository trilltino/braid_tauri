...
// use crate::vendor::diamond_types::{CausalGraph, KVPair, ListOperationCtx, ListOpMetrics, Op, OpContents, CreateValue, CollectionOp, LV};
// use crate::vendor::diamond_types::encoding::map::WriteMap;
// use crate::vendor::diamond_types::encoding::tools::{ExtendFromSlice, push_str, push_u32, push_u64, push_usize};
// use crate::vendor::diamond_types::encoding::varint::{mix_bit_u32, mix_bit_u64, num_encode_zigzag_i64};
// use crate::vendor::diamond_types::list::operation::ListOpKind;
// use crate::vendor::diamond_types::ROOT_CRDT_ID;
// use crate::vendor::diamond_types::rle::RleSpanHelpers;
//
...
//     use crate::vendor::diamond_types::Primitive::*;
//
//     match value {
