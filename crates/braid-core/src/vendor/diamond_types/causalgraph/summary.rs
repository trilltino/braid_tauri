...
use crate::vendor::rle::{HasLength, MergeableIterator, SplitableSpanHelpers};
...
mod serde_encoding {
    ...
    use crate::vendor::diamond_types::causalgraph::summary::{VersionSummary, VersionSummaryFlat, VSEntry};
