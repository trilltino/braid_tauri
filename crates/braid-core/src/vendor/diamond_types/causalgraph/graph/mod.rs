...
use crate::vendor::diamond_types::rle::RleVec;
...
mod tests {
    ...
    use crate::vendor::rle::{MergableSpan, test_splitable_methods_valid};
    use crate::vendor::diamond_types::causalgraph::graph::{Graph, GraphEntrySimple};
    use crate::vendor::diamond_types::encoding::ChunkType::CausalGraph;
