...
use crate::vendor::rle::{MergeableIterator, MergeIter};
use crate::vendor::diamond_types::causalgraph::graph::{Graph, GraphEntryInternal};
...
mod test {
    ...
    use crate::vendor::rle::intersect::{rle_intersect, rle_intersect_first};
    use crate::vendor::rle::MergeableIterator;
